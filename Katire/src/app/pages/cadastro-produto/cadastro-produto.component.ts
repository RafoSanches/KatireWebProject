...
export class CadastroProdutoComponent implements OnInit {
  ...
  salvar() {
    ...
    const fotosFinal = this.fotos.length > 0 ? this.fotos : ['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400'];
    const { titulo, categoria, condicao, descricao, cidade, estado, interesse } = this.form.value;
    const produto = {
      titulo, descricao, categoria, condicao, fotos: fotosFinal,
